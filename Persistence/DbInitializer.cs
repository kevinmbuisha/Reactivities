...
public class DbInitializer
{
    public static async Task SeedData(AppDbContext context, UserManager<User> userManager)
    {
        if (!userManager.Users.Any())
        {
            ...
            {
                new() {DisplayName = "Bob", UserName = "bob@test.com", Email = "bob@example.com"},
                new() {DisplayName = "Tom", UserName = "tom@test.com", Email = "tom@example.com"},
                new() {DisplayName = "Jane", UserName = "jane@test.com", Email = "jane@example.com"}
            };
